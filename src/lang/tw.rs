...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Printer", "打印機"),
        ("printer-os-requirement-tip", "打印機的傳出功能需要Windows 10或更高版本。"),
        ("printer-requires-installed-{}-client-tip", "請先安裝{}用戶端。"),
        ("printer-{}-not-installed-tip", "未安裝{}打印機。"),
        ("printer-{}-ready-tip", "{}打印機已安裝，您可以使用列印功能了。"),
        ("Install {} Printer", "安裝{}打印機"),
        ("Outgoing Print Jobs", "傳出的列印任務"),
        ("Incomming Print Jobs", "傳入的列印任務"),
        ("Incoming Print Job", "傳入的列印任務"),
        ("use-the-default-printer-tip", "使用默認的打印機執行"),
        ("use-the-selected-printer-tip", "使用選擇的打印機執行"),
        ("auto-print-tip", "使用選擇的打印機自動執行"),
        ("print-incoming-job-confirm-tip", "您收到一個遠程列印任務，您想在本地執行它嗎？"),
        ("remote-printing-disallowed-tile-tip", "不允許遠程列印"),
        ("remote-printing-disallowed-text-tip", "被控端的許可權設定拒絕了遠程列印。"),
        ("save-settings-tip", "保存設置"),
        ("dont-show-again-tip", "不再顯示此資訊"),
    ].iter().cloned().collect();
}
